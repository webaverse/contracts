...
const loadPromise = (async () => {
  ...
  BlockchainNetworks.forEach(network => {
    contracts[network] = {
      Account: new web3.eth.Contract(abis.Account, addresses[network].Account),
      FT: new web3.eth.Contract(abis.FT, addresses[network].FT),
      FTProxy: new web3.eth.Contract(abis.FTProxy, addresses[network].FTProxy),
      NFT: new web3.eth.Contract(abis.NFT, addresses[network].NFT),
      NFTProxy: new web3.eth.Contract(abis.NFTProxy, addresses[network].NFTProxy),
      Trade: new web3.eth.Contract(abis.Trade, addresses[network].Trade),
      LAND: new web3.eth.Contract(abis.LAND, addresses[network].LAND),
      LANDProxy: new web3.eth.Contract(abis.LANDProxy, addresses[network].LANDProxy),
    };
  });
})();
